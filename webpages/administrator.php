...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $app->config["site"]; ?>/public/components/data-table/media/css/dataTables.bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $app->config["site"]; ?>/public/components/data-table/extensions/Responsive/css/responsive.bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $app->config["site"]; ?>/public/components/data-table/extensions/Select/css/select.dataTables.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $app->config["site"]; ?>/public/components/data-table/css/pmd-datatable.css">
...
<body>
						...
						<ul class="list-group pmd-list-avatar pmd-card-list">
								...
								<a href="javascript:void(0)">
									<div class="media-left">
										<span class="avatar-list-img40x40">
											<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo $app->config["site"]; ?>/public/images/levi.jpeg" data-holder-rendered="true">
										</span>
									</div>
									<div class="media-body">
										<span class="list-group-item-heading"><span>Levi Ackerman</span> posted new challanegs</span>
							...
							<li class="list-group-item">
								<a href="javascript:void(0)">
									<div class="media-left">
										<span class="avatar-list-img40x40">
											<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo $app->config["site"]; ?>/public/images/zeke.webp" data-holder-rendered="true">
										</span>
									</div>
									<div class="media-body">
										<span class="list-group-item-heading"><span>Zeke Yeager</span> Cloned 2 challenges.</span>
							...
							<li class="list-group-item unread">
								<a href="javascript:void(0)">
									<div class="media-left">
										<span class="avatar-list-img40x40">
											<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo $app->config["site"]; ?>/public/images/reiner.jpeg" data-holder-rendered="true">
										</span>
									</div>

									<div class="media-body">
										<span class="list-group-item-heading"><span>Reiner Braun</span> posted new collection.</span>
							...
							<li class="list-group-item unread">
								<a href="javascript:void(0)">
									<div class="media-left">
										<span class="avatar-list-img40x40">
											<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="<?php echo $app->config["site"]; ?>/public/images/armin.webp" data-holder-rendered="true">
										</span>
									</div>
									<div class="media-body">
										<span class="list-group-item-heading"><span>Armin Arlert</span> Shared 5 collection.</span>
	...
	<script src="<?php echo $app->config["site"]; ?>/public/components/datetimepicker/js/moment-with-locales.js"></script>
	<script src="<?php echo $app->config["site"]; ?>/public/components/datetimepicker/js/bootstrap-datetimepicker.js"></script>

	<script src="<?php echo $app->config["site"]; ?>/public/components/data-table/media/js/jquery.dataTables.min.js"></script>
	<script src="<?php echo $app->config["site"]; ?>/public/components/data-table/media/js/dataTables.bootstrap.min.js"></script>
	<script src="<?php echo $app->config["site"]; ?>/public/components/data-table/extensions/Responsive/js/dataTables.responsive.min.js"></script>
	<script src="<?php echo $app->config["site"]; ?>/public/components/data-table/extensions/Select/js/dataTables.select.min.js"></script>
</body>
