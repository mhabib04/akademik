						...
						<ul class="list-group pmd-list-avatar pmd-card-list">
							...
							<li class="list-group-item unread">
								<a href="javascript:void(0)">
									...
									<div class="media-body">
										<span class="list-group-item-heading"><span>Johny</span> posted new collection.</span>
							...
							<li class="list-group-item unread">
								<a href="javascript:void(0)">
									...
									<div class="media-body">
										<span class="list-group-item-heading"><span>Bjorwi</span> Shared 5 collection.</span>
