...
class FakultasModel {
    ...
    public function search($id) {
        ...
        //curl_setopt($ch, CURLOPT_URL, $config["site"]."/admin/Api/getFakultas/".$id); 
        curl_setopt($ch, CURLOPT_URL, $config["site"]."/Api/getFakultas/".$id); 
...
?>
                        <tr>
                            <td>
                                <a href="<?php echo $app->config["site"]; ?>/admin/Fakultas/edit/<?php echo $v->id; ?>"><i class="material-icons md-dark pmd-sm">edit</i></a>
                                ...
                                <a href="<?php echo $app->config["site"]; ?>/admin/Fakultas/search/<?php echo $v->id; ?>"><i class="material-icons md-dark pmd-sm">help_outline</i></a>
                            </td>
